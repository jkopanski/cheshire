...
module _
  ⦃ eqₛ : Equivalence 𝒮 e ⦄
  ⦃ eqₜ₁ : Equivalence 𝒯₁ e′ ⦄ ⦃ eqₜ₂ : Equivalence 𝒯₂ e″ ⦄
  where

  ※-Homomorphism :
    (F : Homomorphism 𝒮 𝒯₁ eqₛ eqₜ₁) (G : Homomorphism 𝒮 𝒯₂ eqₛ eqₜ₂) →
    Homomorphism 𝒮 (𝒬 𝒯₁ 𝒯₂) eqₛ (eqₜ₁ ×ₑ eqₜ₂)
  ...
  ※-Functor :
    ...
    Functor eqₛ (eqₜ₁ ×ₑ eqₜ₂) S (Product.Category T₁ T₂)
  ※-Functor F G = record
    { morphism = F.morphism ※ G.morphism
...
module _
  ⦃ eqₛ₁ : Equivalence 𝒮₁ e  ⦄ ⦃ eqₛ₂ : Equivalence 𝒮₂ e′ ⦄
  ⦃ eqₜ₁ : Equivalence 𝒯₁ e″ ⦄ ⦃ eqₜ₂ : Equivalence 𝒯₂ e‴ ⦄
  where

  ⁂-Homomorphism :
    (F : Homomorphism 𝒮₁ 𝒯₁ eqₛ₁ eqₜ₁) (G : Homomorphism 𝒮₂ 𝒯₂ eqₛ₂ eqₜ₂) →
    Homomorphism (𝒬 𝒮₁ 𝒮₂) (𝒬 𝒯₁ 𝒯₂) (eqₛ₁ ×ₑ eqₛ₂) (eqₜ₁ ×ₑ eqₜ₂)
  ⁂-Homomorphism F G = record
    { morphism = F.morphism ⁂ G.morphism
    ; isHomomorphism = ⁂-isHomomorphism F.isHomomorphism G.isHomomorphism
    } where module F = Homomorphism F
...
module _
  ...
  assocˡ-Homomorphism : Homomorphism (𝒬 (𝒬 C₁ C₂) C₃) (𝒬 C₁ (𝒬 C₂ C₃)) eqˡ eqʳ
  ...
  assocʳ-Homomorphism : Homomorphism (𝒬 C₁ (𝒬 C₂ C₃)) (𝒬 (𝒬 C₁ C₂) C₃) eqʳ eqˡ
...
module _ ⦃ eqₛ : Equivalence 𝒮 e ⦄ ⦃ eqₜ : Equivalence 𝒯 e′ ⦄ where
  ...
  πˡ-Homomorphism : Homomorphism (𝒬 𝒮 𝒯) 𝒮 (eqₛ ×ₑ eqₜ) eqₛ
  ...
  πˡ-Functor :
    ...
    Functor (eqₛ ×ₑ eqₜ) eqₛ (Product.Category S T) S
  ...
  πʳ-Homomorphism : Homomorphism (𝒬 𝒮 𝒯) 𝒯 (eqₛ ×ₑ eqₜ) eqₜ
  ...
  πʳ-Functor :
    (S : Category.Signature 𝒮) (T : Category.Signature 𝒯) →
    Functor (eqₛ ×ₑ eqₜ) eqₜ (Product.Category S T) T
  ...
  Swap-Homomorphism : Homomorphism (𝒬 𝒮 𝒯) (𝒬 𝒯 𝒮) (eqₛ ×ₑ eqₜ) (eqₜ ×ₑ eqₛ)
  ...
  Swap-Functor :
    (S : Category.Signature 𝒮) (T : Category.Signature 𝒯) →
    Functor (eqₛ ×ₑ eqₜ) (eqₜ ×ₑ eqₛ) (Product.Category S T) (Product.Category T S)
