...
** Hierarchy inversion
*IMPORTANT!* I went back on this take.  When trying to port the monoidal
hierarchy it was a big mess and lot of duplication.  I think the way
to go now is to construct appropriate bundle with all this all this
sorted out.  Given that all the categorical signatures/structures are
parameterized with quiver I should be able to say that this arrow has
this and that structure.

Old comment kept below for now.
